// alert("Bem-vindo(a) ao meu Mini Portfolio")

// OBJETIVO: quando clicarmos na aba temos que mostrar
// o conteúdo da aba que foi clicada pelo usuário e esconder o conteúdo da aba anterior
...
function mostrarInformacoesDaAba(aba) {
  ...
  //passo 6 - mostrar o conteúdo da aba selecionada
  const idDoElementoDeInforamcoesDaAba = `informacao-${aba.id}`;

  const informacaoASerMostrada = document.getElementById(
    idDoElementoDeInforamcoesDaAba
  );
